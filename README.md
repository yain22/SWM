...
The source of data is from [Drillinginfo](https://info.drillinginfo.com/). The data is NOT publically available and there is a cost associated with it charged by the company. Users can purchase the data from the website or can get some similar data and will be able to use our codes. All uploaded codes are Licensed. MUST contact the authors for any use or modification of the uploaded codes for the publication purpose or industrial uses.
